...
import (
	...
	bullshitprogramv1alpha1 "github.com/p-program/kube-killer-operator/pkg/apis/bullshitprogram/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &bullshitprogramv1alpha1.Server{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &bullshitprogramv1alpha1.Server{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileServer) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &bullshitprogramv1alpha1.Server{}
...
func newPodForCR(cr *bullshitprogramv1alpha1.Server) *corev1.Pod {
